...
class OptionsChain:
    ...
    def get_calls(self, expiration: Optional[str] = None) -> list[OptionContract]:
    ...
    def get_puts(self, expiration: Optional[str] = None) -> list[OptionContract]:
...
class ContractHistoryError(Exception):
    """A contract's history could not be fetched, parsed, or trusted."""
